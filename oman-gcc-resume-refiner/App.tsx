  ...
  return (
    <div className="h-screen flex flex-col bg-slate-100">
      ...
      <main className="flex-1 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="w-full lg:w-[30%] h-full bg-white border-r border-slate-200 flex flex-col overflow-y-auto z-10 shadow-lg lg:shadow-none">
           {error && (
        ...
        <div className="w-full lg:w-[70%] h-full bg-slate-100 overflow-y-auto relative flex flex-col items-center">
          <OutputSection 
            result={result} 
            isLoading={isLoading} 
            userInfo={userInfo}
